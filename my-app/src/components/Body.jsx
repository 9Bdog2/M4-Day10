        ...
        <div className="w-100 mt-3 shows-to-try-container">
          ...
          <div className="spotify-card d-flex flex-column">
            <div className="p-2">
              ...
              <div className="mt-2">
                ...
                <p className="text_clamp_2">
                  Eighteen months after 9/11, the United States invaded a
                  country that had nothing to do with the attacks. Who’s to
                  blame? And was there any way to stop it?
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="spotify-card d-flex flex-column">
            <div className="p-2">
              ...
              <div className="mt-2">
                <h6 className="text_clamp_1">
                  A card game of time travel will keep the fluxx out of bedtime
                  as we unbox you off to sleep.
                </h6>
          ...
          <div className="spotify-card d-flex flex-column">
            <div className="p-2">
              ...
              <div className="mt-2">
                ...
                <p className="text_clamp_2">
                  Phoebe Robinson and Jessica Williams host a live comedy show
                  in Brooklyn.
                </p>
              </div>
            </div>
          ...
          <div className="spotify-card d-flex flex-column">
            <div className="p-2">
              ...
              <div className="mt-2">
                ...
                <p className="text_clamp_2">
                  Award-winning podcast from the QI offices in which the writers
                  of the hit BBC show discuss the best things they've found out
                  this week.{" "}
                </p>
              </div>
            </div>
          ...
          <div className="spotify-card d-flex flex-column">
            <div className="p-2">
              ...
              <div className="mt-2">
                ...
                <p className="text_clamp_2">
                  The official podcast of Bitcoin crashes. Hosted by Aaron
                  Lammer &amp; Jay Caspian Kang.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="spotify-card d-flex flex-column">
            <div className="p-2">
              ...
              <div className="mt-2">
                ...
                <p className="text_clamp_2">
                  Comedians W. Kamau Bell &amp; Kevin Avery are absolutely
                  certain of one thing: Denzel Washington is the greatest actor
                  of all time.{" "}
                </p>
              </div>
            </div>
          ...
          <div className="spotify-card d-flex flex-column">
            <div className="p-2">
              ...
              <div className="mt-2">
                ...
                <p className="text_clamp_2">
                  Hollywood Handbook is an insider’s guide to achieving your
                  showbiz dreams from two A-List it-boys who are living theirs.{" "}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="p-2">
              ...
              <div className="mt-2">
                ...
                <p className="text_clamp_2">
                  ...
                  ambassadors as they attempt to establish diplomatic relations
                  with planets in the remote and chaotic
                </p>
              </div>
            </div>
          </div>
